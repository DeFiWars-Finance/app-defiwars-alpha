              ...
              return (
                ...
                return (
                  <div className = { appStyle.flexrow }>
                    {
                      !canClaim &&
                        <div>Scheduled Warfare period still not expired, cannot claim.
                        </ div>
                    }
                    {
                      this.renderJediNFTs()
                  ...
                  return (
                    <div className = { appStyle.flexrow }>
                      <div className = { appStyle.nfblock }>
                        ...
                        <button disabled = { jediLP === 0 } onClick = { this.stakeJedi }>Stake JEDI NFTs
                        </ button>
                      </ div>
                      <div className = { appStyle.nfblock }>
                        ...
                        <button disabled = { darthLP === 0 } onClick = { this.stakeDarth }>Stake DARTH NFTs
                        </ button>
                      </ div>
                    </ div>
                  )
