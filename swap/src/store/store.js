...
class Store extends React.Component {
  constructor(props) {
    ...
    this.store = {
      ...
      NFTs:[
        {
          logo: "api/JEDINFT/YODWARF_iBW(MIAMI).png",
          title: "YoDWARF MIAMI",
          id:1,
          price: 333,
          side: 'jedi',
        ...
        {
          logo: "api/JEDINFT/YODWARF_iBW(CLASSIC).png",
        ...
        {
          logo: "api/JEDINFT/YODWARF_iBW(GOLD).png",
          title: "YoDWARF GOLD",
          id:3,
          price: 66,
          side: 'jedi',
        ...
        {
          logo: "api/JEDINFT/YODWARF_iBW(TURQUOISE).png",
        ...
        {
          logo: "api/JEDINFT/YODWARF_iBW(PINK).png",
          title: "YoDWARF PINK",
          id:5,
          price: 48,
          side: 'jedi',
        ...
        {
          logo: "api/JEDINFT/YODWARF_iBW(GREEN).png",
          title: "YoDWARF GREEN",
          id:6,
          price: 39,
          side: 'jedi',
        ...
        {
          logo: "api/JEDINFT/YODWARF_iBW(BLUE).png",
          title: "YoDWARF BLUE",
          id:7,
          price: 30,
          side: 'jedi',
        ...
        {
          logo: "api/JEDINFT/OBI_DWARF_3D(MIAMI).png",
        ...
        {
          logo: "api/JEDINFT/OBI_DWARF_3D(CLASSIC).png",
        ...
        {
          logo: "api/JEDINFT/OBI_DWARF_3D(GOLD).png",
        ...
        {
          logo: "api/JEDINFT/OBI_DWARF_3D(TURQUOISE).png",
        ...
        {
          logo: "api/JEDINFT/OBI_DWARF_3D(PINK).png",
        ...
        {
          logo: "api/JEDINFT/OBI_DWARF_3D(GREEN).png",
        ...
        {
          logo: "api/JEDINFT/OBI_DWARF_3D(BLUE).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFVADER_iBW(MIAMI).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFVADER_iBW(CLASSIC).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFVADER_iBW(RED).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFVADER_iBW(PURPLE).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFVADER_iBW(TURQUOISE).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFVADER_iBW(GREEN).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFVADER_iBW(PINK).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFSITH_iBW(MIAMI).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFSITH_iBW(CLASSIC).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFSITH_iBW(GREEN).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFSITH_iBW(PINK).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFSITH_iBW(TURQUOISE).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFSITH_iBW(GOLD).png",
        ...
        {
          logo: "api/DARTHNFT/DWARFSITH_iBW(BLUE).png",
  ...
  async peace() {
    if (await this.checkNet()) {
      ...
      const dwarfContract = new web3.eth.Contract(dwarfABI, dwarfAddress);
      try {
        let result = await dwarfContract.methods.peace().send({ from: accountAddress });
      } catch(error) {
        this.setReady(false);
      }
      console.log(result);
  ...
  async war() {
    if (await this.checkNet()) {
      ...
      const dwarfContract = new web3.eth.Contract(dwarfABI, dwarfAddress);
      try {
        const result = await dwarfContract.methods.war().send({ from: accountAddress, });
      } catch(error) {
        this.setReady(false);
      }
      console.log(result);
  ...
  async checkNFT() {
    ...
    console.log(balance);
    const dwarfContract = new web3.eth.Contract(dwarfABI, dwarfAddress);
    const havenft = await dwarfContract.methods.exists(accountAddress).call({ from: accountAddress, });
    console.log(havenft);
    if (havenft) {
      const isInWar = await dwarfContract.methods.isInWar(accountAddress).call({ from: accountAddress, });
  ...
  async getBalances() {
      ...
      const jediContract = new web3.eth.Contract(erc20ABI, lpJediAddress)
      let balance = await jediContract.methods.balanceOf(accountAddress).call({ from: accountAddress });
      balance = parseFloat(balance)/10**18;
      await this.setStore({jediLP:balance});
      console.log(balance);
      const darthContract = new web3.eth.Contract(erc20ABI, lpDarthAddress)
  ...
  async getNFTBalances() {
      ...
      const jediContract = new web3.eth.Contract(erc1155ABI, NFTJediAddress);
      const darthContract = new web3.eth.Contract(erc1155ABI, NFTDarthAddress);
    ...
    if (window.ethereum) { // Modern dapp browsers...
      ...
      try {
        ...
        web3.eth.getAccounts(
          getAccountsCallback(
            this.updateState('accountAddress'),
          ),
        );
      } catch (error) {
        console.error(error);
  ...
  async checkMarket() {
      ...
      try {
        ...
        const dwarfABI = this.getStore("dwarfABI");
        const dwarfContract = new web3.eth.Contract(dwarfABI, dwarfAddress);
        const opened = await dwarfContract.methods.isOpened(accountAddress).call({ from: accountAddress });
        if (opened) {
          console.log(opened);
        }
        await this.setStore({opened:opened});
        emitter.emit('opened', opened);
        const staked = await dwarfContract.methods.staked(accountAddress).call({ from: accountAddress });

        if (staked) {
          console.log(staked);
          let stakedJedi = await dwarfContract.methods.stakedJedi(accountAddress).call({ from: accountAddress });
          stakedJedi = parseFloat(stakedJedi)/10**18;
          await this.setStore({stakedJedi:stakedJedi});
          let stakedDarth = await dwarfContract.methods.stakedDarth(accountAddress).call({ from: accountAddress, });
          stakedDarth = parseFloat(stakedDarth)/10**18;
          await this.setStore({stakedDarth:stakedDarth});
          const canClaim = await dwarfContract.methods.canClaim(accountAddress).call({ from: accountAddress, });
